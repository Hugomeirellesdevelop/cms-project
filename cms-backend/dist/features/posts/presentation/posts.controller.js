...
let PostsController = class PostsController {
    ...
    async saveImage(image, id) {
        if (!image)
            throw new common_1.HttpException('teste', common_1.HttpStatus.BAD_GATEWAY);
...
__decorate([
    (0, common_1.Post)('upload/arquivos'),
...
__decorate([
    (0, common_1.Post)('upload/arquivo'),
...
], PostsController.prototype, "saveImage", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)('/findAllPostsFromCategoria/:categoriaId'),
    __param(0, (0, common_1.Param)('categoriaId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PostsController.prototype, "findAllPostsFromCategoria", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PostsController.prototype, "getImage", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
